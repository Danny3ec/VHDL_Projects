...
-- SW£,SW2,SW0 = select one of 8 NCO frequency presets (10Hz -> 10 KHz)

library ieee;
use ieee.std_logic_1164.all;
use ieee.numeric_std.all;

entity top_original is
  port (
...
architecture rtl of top_original is
  -- NCO core
...
begin
  ...
  ---------------------------------------------------------------------------
  -- Your original tiny blinker driving LEDR0 (independent of switches now)
  ---------------------------------------------------------------------------
